---
title: "Labeled Legal, Raised by Narcos — What the USDA Won’t Tell You About Imported Cattle"
pubDate: 2025-07-09
author: "Beef News"
...
After nearly a year of emergency closures, U.S. cattle ports are beginning to [reopen](https://www.usda.gov/about-usda/news/press-releases/2025/06/30/usda-announces-phased-reopening-southern-ports-livestock-trade)—starting with Douglas, Arizona, with Columbus and Santa Teresa, New Mexico expected next. That means **live cattle from Mexico are once again flowing north**, tagged, dipped, and USDA-cleared for entry.
...
[Santa Teresa](https://nmdeptag.nmsu.edu/marketing/international-livestock-export-import.html#gsc.tab=0) may be the busiest cattle import station in America. But it’s **what crosses that should worry you**.

A growing body of [evidence](https://insightcrime.org/wp-content/uploads/2022/05/Cash-Cows-The-Inner-Workings-of-Cattle-Trafficking-from-Central-America-to-Mexico-InSight-Crime-May-2022.pdf) shows that cartel-linked cattle from **northern Jalisco** are entering American supply chains with USDA paperwork—and no one is watching the real owners.
...
In [October 2022](https://www.ameg.org.mx/produccion/24-08-2023-los-senores-del-ganado-y-la-plata-la-expansion-del-cjng-en-el-norte-de-jalisco/), ranchers across ten municipalities in Jalisco were summoned—some to meetings, others by threat. The **Cártel Jalisco Nueva Generación (CJNG)** forcibly took over the regional cattle trade. They imposed a commission—**5 pesos per kilo**—on every export-bound animal.

The cartel didn’t need guns. It had **spreadsheets**.

CJNG appointed regional “managers” in towns like **Colotlán** and **Huejúcar** to enforce the racket. Bureaucrats at the municipal level distributed transit guides and export certificates—plugged into [**SENASICA**](https://www.gob.mx/senasica), the national animal ID system—feeding CJNG real-time data on herd movement, births, and ownership.
...
By early 2023, [**over 100,000 cattle** per year](https://www.ameg.org.mx/produccion/24-08-2023-los-senores-del-ganado-y-la-plata-la-expansion-del-cjng-en-el-norte-de-jalisco) were flowing through cartel-controlled regions—many bound for U.S. export.
...
In 2024, USDA shut down live imports due to a [**resurgence of New World Screwworm**](https://newsroom.wcs.org/News-Releases/articleType/ArticleView/articleId/18230/WCS-Statement-on-Screwworm-Eradication-and-the-Resumption-of-Cattle-Trade-from-Mexico.aspx), a parasitic fly that eats live tissue. Outbreaks were centered in **Veracruz**, **Campeche**, and **Yucatán**—the same regions where smuggled cattle from Central America enter Mexico.
...
Once these animals are funneled into **[TIF slaughterhouses](https://www.gob.mx/senasica/documentos/meat-from-tif-establishments-a-guarantee-of-hygiene-and-safety)**, they’re indistinguishable from legitimate cattle. And yes, their boxed meat is **eligible for U.S. export**.
...
— Dixie Suddreth, [Real Red Meats](https://www.beefmaps.com/?link=11) in Farson, WY*
...
In northern Jalisco, **CJNG’s grip on the cattle trade** isn’t just financial—it’s paramilitary. In early 2025, Mexican search brigades uncovered **mass graves, charred bones, clothing, and cattle skulls** at a suspected ranch called [**Rancho Izaguirre**](https://apnews.com/article/mexico-cartel-violence-izaguirre-ranch-jalisco-fd5d658afcfe9835a2a5d81ad11df957). It wasn’t a farm—it was an **extermination site**.
...
— [**Washington Post**, July 2025](https://www.washingtonpost.com/world/2025/07/08/mexico-cartel-violence-izaguirre-ranch-jalisco/dde444c0-5c5d-11f0-a293-d4cc0ca28e5a_story.html?utm_source=chatgpt.com)*

Despite multiple warnings from state human rights officials since 2021, authorities didn’t act until bones surfaced in 2025. This mirrors accounts from [whistleblowers and forensic auditors](https://youtu.be/2BNPcOLGgcs) claiming the **USDA may have discovered fraud and abuse at ranches like this—but backed off due to cartel fear**.

It’s a warning: **cartel cattle doesn’t just depress prices. It destabilizes human life.**

Yet under current [USDA rules](https://www.aphis.usda.gov/sites/default/files/animal-id-device-standards.pdf), once those animals are tagged and processed, their meat—no matter the blood behind it—can enter the U.S. supply chain unchecked.
...
This isn’t isolated. As **InSight Crime** has shown, **cartels now control sectors like avocados, limes, and cattle**. A [**2004 U.S. Treasury probe**](https://home.treasury.gov/news/press-releases/js2686) found that Mexican cartels used cattle firms in **Chihuahua** to launder drug money—including one with a U.S. satellite office in **Presidio, Texas**.

And in 2025, **Hudspeth County Sheriff Arvin West** [claimed](https://tennesseestar.com/justice/cash-cows-gangs-allegedly-smuggling-drugs-across-border-inside-cattle/dsignal/2025/03/18/) Mexican smugglers were hiding **fentanyl inside heifers**, using port-of-entry procedures to avoid detection. CBP dismissed the claim—at Santa Teresa specifically—but acknowledged **they can’t rule it out elsewhere**.

###### **Why It Matters for American Ranchers**

- [USDA](https://usaha.org/upload/Resolution/2021/Responses/Res2021_19_CCB_EID_Mexican_Rodeo.pdf) has **no protocol** to trace Mexican cattle to ranch-level origin
...
The USDA now calls **“**[**Farm Security is National Security**](https://www.usda.gov/sites/default/files/documents/farm-security-nat-sec.pdf)**”**. But what about food sovereignty?

Start here: [**Mandatory Country-of-Origin Labeling**](https://www.r-calfusa.com/label-our-beef/) **(MCOOL)**. It’s not a slogan—it’s a lifeline for every American rancher being undercut by cartel-cleared imports passed off as U.S. beef. Reinstating **MCOOL** puts a floor under the market.

But it’s not enough. Because **“Product of USA”** means nothing if we still don’t know the rancher.

That’s why the next standard is **[Rancher-of-Origin](https://beefmaps.com)**. Traceability to the herd, the pasture, the human being. Not just for imports—but for domestic trade too. Especially now, when multinational packers are blending boxed beef from every continent into your local grocery case.

*“You need to know the person who calved that cow. Where it was born. Where it lived its entire life.”\
— [**Shanen Ebersole**, Ebersole Cattle Co.](https://www.ebersolecattleco.com)*

And then—**burn the tax that funds the betrayal.**

The [**beef checkoff**](https://farmaction.us/2023/09/14/surprising-no-one-ncba-awards-itself-the-biggest-checkoff-contract-again/) steals tens of millions from independent ranchers every year to bankroll ads that benefit the same four packers flooding the system with cartel-cleared cattle. It’s not a promotion program—it’s a [monopoly subsidy](https://www.thefencepost.com/news/if-the-beef-checkoff-is-working-who-is-it-working-for/).
...
[**Know Your Rancher\**](https://beefmaps.com)Label it. Trace it. ***Fund freedom—not your extinction.***
