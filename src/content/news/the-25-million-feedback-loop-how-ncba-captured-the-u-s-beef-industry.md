---
title: "The $25 Million Feedback Loop: How NCBA Captured the U.S. Beef Industry"
pubDate: 2025-09-20
author: "Beef News"
...
Under federal law, every U.S. cattle producer is required to pay **$1 per head** into the [**Beef Checkoff**](https://www.beefboard.org/checkoff/), a national program originally designed to promote beef for the benefit of all ranchers. But today, nearly **two-thirds of that $38 million annual fund** flows straight into the hands of a single organization: the **National Cattlemen’s Beef Association (NCBA)**—a trade group aligned with Big Four packers like **JBS, Cargill, National Beef and Tyson**.
...
The Beef Checkoff was created under [**7 U.S.C. § 2901 et seq.**](https://www.law.cornell.edu/uscode/text/7/2904), administered by USDA and managed by the [**Cattlemen’s Beef Board (CBB)**](https://www.beefboard.org/). Its funding is allocated by the **Beef Promotion Operating Committee (BPOC)**—a 20-member board split evenly between USDA-appointed CBB members and state-nominated reps from the **Federation of State Beef Councils (FSBC)**.
...
According to NCBA’s own [**2024 Federation Annual Report**](https://www.ncba.org/Media/NCBA2025/Docs/2024-federation-annual-report-withfinancials.pdf), these FSBC members include:
...
On the USDA-appointed side, the [**CBB’s Ryan Moorhouse**](https://www.beefboard.org/beef-board/about-beef-board/members/ryan-moorhouse/) served on NCBA’s board while managing [**Hartley Feeders**](https://www.fiveriverscattle.com/hartley-feeders/), a **Five Rivers** operation that supplies to packers.
...
- **$22.3M** to promotion
- **$14.8M** to research
- And [**$25.4 million**](https://www.beefboard.org/2023/10/03/2024-beef-checkoff-program-funding/) to **NCBA-led projects**

While [**NCBA's direct compensation is listed as just $737,913**](https://www.beefboard.org/wp-content/uploads/2023/12/2-02-2024-Board-Meeting-Draft-Minutes.pdf), this **grossly understates** the reality. NCBA receives **the lion’s share of contract awards** through reimbursement, subcontracting, and pass-through ARs (Authorization Requests)—all approved by a board they control.

This isn’t a new pattern:

- In **2005**, NCBA received **87% of all Checkoff funds**
- In **2023–2025**, they’ve consistently captured **65%+**, per [**AMS summaries**](https://www.beefboard.org/2023/10/03/2024-beef-checkoff-program-funding/)

https://twitter.com/QShieldknight/status/1969019069694165015
...
Meanwhile, **no funding goes to groups advocating for reforms** like **Mandatory Country of Origin Labeling (MCOOL)**—which NCBA [**helped repeal in 2015**](https://www.foodsafetynews.com/2015/12/usda-ends-cool-enforcement-with-presidents-signature-on-omnibus-bill/) after suing to block it in 2013.

*“**Philip Ellis, president of the Denver-based National Cattlemen’s Beef Association, said repeal of COOL was one of several victories for cattlemen and woman that were contained in the omnibus.**”* - [Food Safety News](https://www.foodsafetynews.com/2015/12/usda-ends-cool-enforcement-with-presidents-signature-on-omnibus-bill/)
...
Despite findings that **NCBA failed to maintain separate accounts** for lobbying vs. promotional activities, the [**2024 audit minutes**](https://www.beefboard.org/wp-content/uploads/2024/09/02-04-2025-Budget-and-Audit-Committee-Draft-Meeting-Minutes.pdf) declared “no material noncompliance.”
...
Under [**7 U.S.C. § 2904**](https://www.law.cornell.edu/uscode/text/7/2904), **USDA is legally prohibited from placing employees on the CBB or BPOC**. The board must be producer/importer-led, with members nominated by industry groups and appointed by USDA. These appointments are procedural, not directional—**USDA has no vote and no veto** over BPOC funding decisions.

The USDA’s enforcement role is carried out via the [**AMS Livestock, Poultry, and Seed Program**](https://www.ams.usda.gov/about-ams/organizational-chart), led by officials like **Dave Tuckwiller**, who oversees audit coordination but holds **no contracting authority**. According to [**7 CFR Part 1260**](https://www.ecfr.gov/current/title-7/subtitle-B/chapter-XI/part-1260), AMS’s job is to **review budgets and ensure compliance**—not control outcomes.
...
- [**Five Rivers’ Hartley Feeders**](https://www.fiveriverscattle.com/hartley-feeders/)—connected to NCBA’s Moorhouse—sells to JBS.\

https://twitter.com/beefinitiative/status/1969242409557987806

Ethics watchdogs like Public Citizen call it what it is: **regulatory capture through human capital flow**. And yet, despite [**2020 subpoenas on Big 4 collusion**](https://texasagriculture.texasfarmbureau.org/articles/doj-subpoenas-four-major-beef-packers), **no DOJ prosecutions** ever followed.
...
**The** [**OFF Act**](https://www.booker.senate.gov/news/press/booker-lee-introduce-off-act-to-protect-farmers-cut-government-waste) **(H.R. 2813)** and [similar proposals](https://labelourbeef.com) aim to **ban conflicts of interest**, mandate public audits, and prevent trade associations like NCBA from double-dipping.

But legislation alone won’t save independent producers.

**Sunlight is the first disinfectant.****\****Transparency is the first strike.****\****Defunding the cartel is the kill shot.**
...
*We apply this metric using a logic-based heuristic rooted in Occam’s Razor developed by [@DiligentDenizen](https://x.com/DiligentDenizen): When a pattern benefits the same actors, persists despite exposure, and is shielded from scrutiny, deliberate design becomes more probable than accident.*
